...
export class NewComponent implements OnInit {
  ...
  newENAppliancesForm = this._formBuilder.group({
  ...
  ngOnSubmit(): void {
    const formValues = this.newENAppliancesForm.value;
    ...
    this._appService.uploadFile(this.ADVideo).subscribe((response: any) => {
      ...
      if (response.fileStorageID != null || undefined) {
        ...
        this._ENAppliancesService.newENAppliance(eNAppliance).subscribe((response: any) => {
