...
@Component({
  selector: 'app-update-LNProperty',
  templateUrl: './updateLNProperty.component.html',
  styleUrl: './updateLNProperty.component.scss'
})
export class UpdateLNPropertyComponent implements OnInit {
  ...
  updateLNPropertiesForm = this._formBuilder.group({
